# Contributing to Frequenz microgrid-formula-engine-rs


## Build

You can use `maturin build` to simply build the source and binary distribution:
...
Then build the Rust wheel and install it:
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/frequeny-microgrid-formula-engine-rs/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/frequenz-microgrid-formula-engine-rs/)
   automatically.
